...
/**
 * Representa um dispositivo (microcontrolador).
 * Todo dispositivo está associado a um usuário (owner).
 * Representa uma tabela no banco de dados, especificamente a tabela principal para dispositivos.
 * 
 * @author Cláudio Zicri (ZiKriDev)
 * @since 0.1.0
 */
 ...
 public class Device implements Serializable {
      ...
      * Permite consultas eficientes de dispositivos por nome.
     */
     @PrimaryKeyClass
     @NoArgsConstructor
     @AllArgsConstructor
     ...
     public Device(DeviceByUserId device, DeviceKey key) {
         this.key = key;
         ...
         this.ownerId = device.getKey().getOwnerId();
     }
