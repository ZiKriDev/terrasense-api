...
@Table("tb_devices_by_api_key")
@NoArgsConstructor
@AllArgsConstructor
@Getter
@Setter
@EqualsAndHashCode(of = "key")
public class DeviceByApiKey {
    ...
    @Getter
    @Setter
    public static class DeviceByApiKeyKey {

        @PrimaryKeyColumn(name = "apiKey", type = PrimaryKeyType.PARTITIONED)
    ...
    public DeviceByApiKey(Device device, DeviceByApiKeyKey key) {
        this.key = key;
